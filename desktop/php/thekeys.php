...
sendVarToJS('eqType', 'thekeys');
$eqLogics = eqLogic::byType('thekeys');
          ...
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement thekeys}}"/>
              </div>
            </div>
            <div class="form-group">
...
<?php include_file('desktop', 'thekeys', 'js', 'thekeys'); ?>
